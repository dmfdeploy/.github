# CLAUDE — dmfdeploy/.github (org community health + profile)

This is the dmfdeploy ORG-DEFAULT community-health and profile repo — it
hosts the org profile README, fallback CODE_OF_CONDUCT, SUPPORT, and
GOVERNANCE files. Per-repo files always win; these are the org-level
defaults. Cross-repo context (status, decisions, plans, skills) lives in the
[dmfdeploy umbrella repo](https://github.com/dmfdeploy/dmfdeploy), checked
